...
@section('panel')
    ...
    <div class="row mb-none-30">
                ...
                <div class="card-body p-0">
                    <div class="d-flex p-3 bg--primary">
                        <div class="avatar avatar--lg">
                            <img src="{{ getImage(getFilePath('adminProfile').'/'. $staff->image,getFileSize('adminProfile'))}}" alt="@lang('Image')">
                        </div>
                        <div class="ps-3">
        ...
        <div class="col-lg-7 col-md-7 mb-30">
            <div class="card">
                <div class="card-body">
                    <h5 class="card-title mb-3 border-bottom ">@lang('Change Password')</h5>

                    <form action="{{ route('pharmacie.password.update') }}" method="POST" enctype="multipart/form-data">
                        @csrf
...
<div class="d-flex flex-wrap justify-content-end gap-2 align-items-center">
    <a href="{{route('pharmacie.profile')}}" class="btn btn-sm btn-outline--primary" ><i class="las la-user"></i>@lang('Profile Setting')</a>
</div>
@endpush
