    ...
    <div class="login-main" style="background-image: url('{{ asset('assets/viseradmin/images/login.jpg') }}')">
        <div class="container custom-container d-flex justify-content-center">
            <div class="login-area">
                ...
                <form action="{{ route('password.verify.code') }}" method="POST" class="login-form w-100">
                    @csrf
                    ...
                    <div class="d-flex flex-wrap justify-content-between">
                        <a href="{{ route('password.request') }}" class="forget-text">@lang('Try to send again')</a>
                    </div>
                    <button type="submit" class="btn cmn-btn w-100 mt-4">@lang('Submit')</button>
                </form>
                <a href="{{ route('login') }}" class="text-white mt-4"><i class="las la-sign-in-alt"
