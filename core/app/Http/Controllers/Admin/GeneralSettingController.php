...
class GeneralSettingController extends Controller
{
    ...
    {
        $pageTitle = 'Custom Module';
        $file =   activeModules(); 
        $file_content = @file_get_contents($file);
        return view('admin.setting.custom_module', compact('pageTitle', 'file_content'));
    }


    public function customModuleSubmit(Request $request)
    {
        $file =   activeModules(); 
        if (!file_exists($file)) {
            fopen($file, "w");
        }
        file_put_contents($file, $request->module);
